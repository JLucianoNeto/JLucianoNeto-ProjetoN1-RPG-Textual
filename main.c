...
int matriz[19][7], vetor_apoio[1][6];
...
void desc_salas(int id_sala)
{
    ...
    case 10:
        if (chave == 0)
        {
            printf("Neste lugar, você percebe que a porta atras de você se fechou sozinha. Em pânico você busca uma saída, mas a única porta disponível está trancada\n");
